...
1. Collected and consolidated e-commerce sales data from Kaggle datasets to build a structured analytical dataset.
2. Cleaned and transformed raw data by handling inconsistencies, missing values, and formatting issues to improve data quality.
3. Analyzed sales, orders, revenue, profit, quantity, and customer/product performance to identify key business trends and patterns.
